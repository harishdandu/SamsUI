...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { name: 'Fees', icon: <CreditCard size={20} />, path: '/fees', roles: ['admin','accountant', 'super admin'] },
    { name: 'Pending Fees', icon: <Clock size={20} />, path: '/pending-fees', roles: ['admin','accountant', 'super admin'] },
    { name: 'Ledgers', icon: <BookOpen size={20} />, path: '/ledger', roles: ['admin','accountant', 'super admin'] },
    ...
    { name: 'Class Teachers', icon: <Users size={20} />, path: '/class-teachers', roles: ['super admin', 'admin', 'teacher', 'hr'] },
